...
serve(async (req) => {
  ...
  // Validate caller and get user_id via the JWT
  ...
  // 2. open bursary requirements (most recent 60)
  ...
  // 3. ask Lovable AI to score each bursary
  const aiBody = {
